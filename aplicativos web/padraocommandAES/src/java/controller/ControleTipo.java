 ...
 * @author alunocmc
 */
@WebServlet(name = "ControleTipo", urlPatterns = {"/ControleTipo"})
public class ControleTipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Listar = fRzggtDk94iqvfhCbUL%2Bxg%3D%3D
            String acao = "";
            acao = decrypt(request.getParameter("acao"));

            if (acao == null) {
                acao = decrypt(URLDecoder.decode(request.getParameter("acao"), "UTF-8"));
            }
            String nomedaclasse = "command." + acao + "TipoAction";
