...
public class TipoDao implements ITipodao {
    ...
    private static final String BUSCARPORIDDEPTO = "SELECT * FROM tipo WHERE departamento=?";

    private Object pstmt;
    private Connection conexao;
    
    public ArrayList<Tipo> listarpordepartamento(Tipo tipo) {
        ...
        try {
            ...
            //cria comando SQL
            PreparedStatement pstmt = conexao.prepareStatement(BUSCARPORIDDEPTO);
            
            
            pstmt.setInt(1, tipo.getIdDepartamento());
