...
public class SituacaoDao implements ISituacaodao {
    ...
    private static final String SELECT_ALL = "SELECT * FROM situacoes where descricao ilike ?;";
    private static final String INSERT = "INSERT INTO situacoes (descricao) values(?);";
    private static final String DELETE = "DELETE FROM situacoes where id=?";
    private static final String BUSCAR = "SELECT * FROM situacoes WHERE id=?;";
    private static final String UPDATE = "UPDATE situacoes set descricao=? WHERE id=?";
