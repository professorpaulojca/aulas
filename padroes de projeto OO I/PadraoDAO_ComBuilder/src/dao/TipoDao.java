...
public class TipoDao implements ITipodao {
    ...
    private static final String SELECT_ALL = "SELECT * FROM tipos where descricao ilike ?;";
    private static final String INSERT = "INSERT INTO tipos (descricao) values(?);";
    private static final String DELETE = "DELETE FROM tipos where id=?";
    private static final String BUSCAR = "SELECT * FROM tipos WHERE id=?;";
    private static final String UPDATE = "UPDATE tipos set descricao=? WHERE id=?";
